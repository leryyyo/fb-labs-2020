...
for j in range(0,2,1):
    ...
    file=file.replace('ё','е').replace('ъ','ь').replace('/n','').replace('  ',' ').replace('  ',' ')
...
# биграммы
    ...
    print("Ентропія біграми з повторенням: ",entr)  
    print("Надлишковість біграми з повторенням: ",nadl)     
    print()
    ...
    print("Ентропія біграми без повторень: ",entr)   
    print("Надлишковість біграми без повторень: ",nadl)
    print()
    ...
    print("Ентропія <H(10): ",entr1)   
    print("Надлишковість <H(10): ",nadl1)
    print("Ентропія H(10)<: ",entr2)   
    print("Надлишковість H(10)<: ",nadl2)
    print()
    ...
    print("Ентропія <H(20): ",entr1)   
    print("Надлишковість <H(20): ",nadl1)
    print("Ентропія H(20)<: ",entr2)   
    print("Надлишковість H(20)<: ",nadl2)
    print()
    ...
    print("Ентропія <H(30): ",entr1)   
    print("Надлишковість <H(30): ",nadl1)
    print("Ентропія H(30)<: ",entr2)   
    print("Надлишковість H(30)<: ",nadl2)
